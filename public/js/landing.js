...
class LandingPage {
  ...
  setupLanguageSwitcher() {
    // Restore language switcher state on page load
  ...
  setupThemeToggle() {
    // Universal function to update theme icons (both desktop and mobile)
    window.updateAllThemeIcons = function(theme) {
      const allThemeIcons = document.querySelectorAll('#theme-toggle .theme-icon, #mobile-theme-toggle .theme-icon');
    ...
    if (window.updateAllThemeIcons) {
      window.updateAllThemeIcons(currentTheme);
    }
  }
